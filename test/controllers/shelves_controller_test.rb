...
class ShelvesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shelf" do
    assert_difference("Shelf.count") do
      post shelves_url, params: { shelf: { quantity: @shelf.quantity, row_number: @shelf.row_number } }
    end
  ...
  test "should update shelf" do
    patch shelf_url(@shelf), params: { shelf: { quantity: @shelf.quantity, row_number: @shelf.row_number } }
